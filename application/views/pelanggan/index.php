...
<section class="popular-foods padding-tb">
	<div class="container">
		<div class="section-header">
			<h3>Tempat Cuci Terpopular</h3>
			<p>Tempat cuci paling popular dengan melayani pencucian terbanyak</p>
		</div>
		<div class="section-wrapper">
			<div class="row">
				<?php foreach ($tempat_cuci_popular as $tempat_cuci_popular) : ?>
				<div class="col-lg-6 col-12">
					<div class="p-food-item style-2">
						<div class="p-food-inner">
							<div class="p-food-thumb">
								<a href="<?= base_url('Pelanggan/tempat/') . $tempat_cuci_popular->id; ?>"><img
											style="width: 340px; height: 250px;object-fit: cover;"
											src="<?= base_url('uploads/tempat_cuci/foto2/'); ?><?= $tempat_cuci_popular->foto2; ?>"
											alt="p-food"></a>
								<span><?= rupiah($tempat_cuci_popular->harga_motor); ?> - <?= rupiah2($tempat_cuci_popular->harga_mobil); ?></span>
							</div>
							<div class="p-food-content">
								<h6><a href="#"><?= $tempat_cuci_popular->nama ?></a></h6>
								<div class="p-food-group">
									<span>Jumlah Pencucian : </span>
									<a href="<?= base_url('Pelanggan/tempat/') . $tempat_cuci_popular->id; ?>"><?= $tempat_cuci_popular->jumlah ?></a>
								</div>
								<ul class="del-time">
									<li>
										<i class="icofont-cycling-alt"></i>
								...
								<div class="p-food-footer">
									<div class="left">
										<div class="rating">
											<?php if ($tempat_cuci_popular->rating == 1) { ?>
												<i class="icofont-star"></i>
												<i class="icofont-star text-light"></i>
												<i class="icofont-star text-light"></i>
												<i class="icofont-star text-light"></i>
												<i class="icofont-star text-light"></i>
											<?php } elseif ($tempat_cuci_popular->rating == 2) { ?>
												<i class="icofont-star"></i>
												<i class="icofont-star"></i>
												<i class="icofont-star text-light"></i>
												<i class="icofont-star text-light"></i>
												<i class="icofont-star text-light"></i>
											<?php } elseif ($tempat_cuci_popular->rating == 3) { ?>
												<i class="icofont-star"></i>
												<i class="icofont-star"></i>
												<i class="icofont-star"></i>
												<i class="icofont-star text-light"></i>
												<i class="icofont-star text-light"></i>
											<?php } elseif ($tempat_cuci_popular->rating == 4) { ?>
												<i class="icofont-star"></i>
												<i class="icofont-star"></i>
												<i class="icofont-star"></i>
												<i class="icofont-star"></i>
												<i class="icofont-star text-light"></i>
											<?php } elseif ($tempat_cuci_popular->rating == 5) { ?>
												<i class="icofont-star"></i>
												<i class="icofont-star"></i>
												<i class="icofont-star"></i>
												<i class="icofont-star"></i>
									...
									<div class="right"><i class="icofont-home"></i><?= $tempat_cuci_popular->alamat ?></div>
								</div>
							</div>
						</div>
					</div>
